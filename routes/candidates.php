...
Route::patch('/candidats/{candidat}/status', [CandidatController::class, 'updateStatus'])->name('candidats.update-status');
Route::patch('/candidats/{candidat}/quick-update', [CandidatController::class, 'quickUpdate'])->name('candidats.quick-update');
