            ...
            <div className="min-h-screen bg-gray-50 px-6 py-10 transition-colors duration-300 dark:bg-[#0f1117]">
                ...
                <div className="mb-10">
                    ...
                    <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                        {/* TITLE */}
                        <div>
                            <p className="mb-2 text-xs font-semibold tracking-widest text-indigo-500 uppercase">Recruitment / Briefs</p>

                            <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Brief Management</h1>

                            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Manage and track all your recruitment briefs efficiently.</p>
                        </div>
                            ...
                            render: (b) => (
                                <span
                                    className={`font-semibold ${
                                        b.gender_pref === 'M' ? 'text-blue-600 dark:text-blue-400' : 'text-red-600 dark:text-red-400'
                                    }`}
                                >
                                    {b.gender_pref === 'M' ? 'Homme' : b.gender_pref === 'F' ? 'Femme' : b.gender_pref}
                                </span>
                            ),
                        },
