    ...
    return (
        <AppSidebarLayout>
            <div className="min-h-screen bg-gray-50 p-8 text-gray-900 dark:bg-[#0A0A0F] dark:text-white">
                {/* HEADER */}
                <div className="mb-6">
                    <p className="text-xs text-gray-500">Sourcing › Modifier brief</p>
                    <h1 className="text-secondary text-2xl font-bold">Modifier un brief</h1>
                </div>
                ...
                <form onSubmit={submit} className="grid grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className={cardClass}>
                            ...
                            <input className={inputClass} placeholder="Titre" value={data.title} onChange={(e) => setData('title', e.target.value)} />
