...
        // We MUST use to get the first file from the list
...
                disabled={uploading}
                className={`w-full rounded-lg py-2 font-bold text-white transition-all ${uploading ? 'bg-gray-400' : 'bg-blue-600 hover:bg-blue-700'}`}
            >
